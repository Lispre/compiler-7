...
class_implementation_body:
	instance_variables	implementation_definition_list	AT_END	{cout<<"class_implementation_body: instance_variables	implementation_definition_list	AT_END\n";}
	|instance_variables									AT_END	{cout<<"class_implementation_body: instance_variables									AT_END\n";}
	|					implementation_definition_list	AT_END	{cout<<"class_implementation_body:						implementation_definition_list	AT_END\n";}
;
implementation_definition_list:
	implementation_definition_list implementation_definition	{i=3;cout<<"implementation_definition_list: implementation_definition_list implementation_definition\n";}
	|implementation_definition									{i=3;cout<<"implementation_definition_list: implementation_definition\n";}
;
...
instance_implementation_definition_header:
	...
	|MINUS				method_selector			{cout<<"instance_implementation_definition_header:MINUS 			method_selector\n";}
;
statement_list:
...
statement:
	...
	|expr SEMI_COMA							{cout<<"statement: expr\n";}
...
loop_statement:
	...
	|do_while_loop							{cout<<"loop_statement: do_while_loop\n";}
;
for_loop:
...
logic_expr:
	...
	|logic_expr AND_AND logic_expr		{cout<<"logic_expr:logic_expr AND_AND logic_expr\n";}
...
;
logic_expr2:
	 expr2 LESS_THAN expr2				{cout<<"logic_expr:expr LESS_THAN expr\n";}
	|expr2 MORE_THAN expr2				{cout<<"logic_expr:expr MORE_THAN expr\n";}
	|expr2 LESS_OR_EQUAL expr2			{cout<<"logic_expr:expr LESS_OR_EQUAL expr\n";}
	|expr2 MORE_OR_EQUAL expr2			{cout<<"logic_expr:expr MORE_OR_EQUAL expr\n";}
	|expr2 EQUAL_EQUAL expr2				{cout<<"logic_expr:expr EQUAL_EQUAL expr\n";}
	|NOT_EQUAL expr2						{cout<<"logic_expr:NOT_EQUAL expr\n";}
	|OPEN_P logic_expr2 CLOSE_P			{cout<<"logic_expr:OPEN_P logic_expr CLOSE_P\n";}
	|logic_expr2 AND_AND logic_expr2		{cout<<"logic_expr:logic_expr AND_AND logic_expr\n";}
	|logic_expr2 OR_OR logic_expr2		{cout<<"logic_expr:logic_expr OR_OR logic_expr\n";}
...
simple_expr:
	...
	|simple_expr DIV simple_expr	{cout<<"simple_expr:expr DIV expr\n";}
...
;
block_body:
	OPEN_S 		statement_list			CLOSE_S			{ cout<<"block_body:OPEN_S statement_list	CLOSE_S\n";}
	|OPEN_S 				CLOSE_S						{ cout<<"block_body:OPEN_S 					CLOSE_S\n";}
;
while_loop:
	while_loop_header statement			{cout<<"while_loop:while_loop_header statement\n";}
;
while_loop_header:
...
;
do_while_loop:
	DO statement while_loop_header SEMI_COMA		{cout<<"do_while_loop_header: DO statement while_loop_header SEMI_COMA\n";}
conditional_statement:
	if_header statement		%prec if_h			{cout<<"conditional_statement: if_header statement\n";}
	|if_header statement	ELSE 	statement	{cout<<"conditional_statement: if_header statement\n";}
	| switch {cout<<"conditional_statement: switch\n";}
;
switch:
SWITCH OPEN_P switch_statement CLOSE_P OPEN_S switch_body CLOSE_S {cout<<"switch statment";}
...
switch_body:
CASE OPEN_P case_statement CLOSE_P SEMI_COLUMN statement BREAK SEMI_COMA switch_body {cout<<"case statment";}
...
|DEFAULT SEMI_COLUMN statement BREAK SEMI_COMA {cout<<"default statment";}
...
;
argument:
	SEMI_COLUMN simple_expr						{cout<<"argument: SEMI_COLUMN simple_expr\n";}
	|error simple_expr							{Er->errQ->enqueue(yylval.r.myLineNo,yylval.r.myColno,"ERROR",":");} 
	|IDENTIFIER SEMI_COLUMN simple_expr			{cout<<"argument: IDENTIFIER SEMI_COLUMN simple_expr\n";}
